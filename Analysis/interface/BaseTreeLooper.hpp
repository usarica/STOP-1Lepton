...
template<> void BaseTreeLooper::getConsumedMap<unsigned long long>(std::unordered_map<TString, unsigned long long*>*& theMap){ theMap = &valulonglongs; }
...
template<> void BaseTreeLooper::getConsumedMap<CMSLorentzVector>(std::unordered_map<TString, CMSLorentzVector*>*& theMap){ theMap = &valCMSLorentzVectors; }
...
template<> void BaseTreeLooper::getConsumedMap<std::vector<unsigned long long>>(std::unordered_map<TString, std::vector<unsigned long long>*>*& theMap){ theMap = &valVulonglongs; }
...
template<> void BaseTreeLooper::getConsumedMap<std::vector<CMSLorentzVector>>(std::unordered_map<TString, std::vector<CMSLorentzVector>*>*& theMap){ theMap = &valVCMSLorentzVectors; }
...
template<> void BaseTreeLooper::getConsumedMap<unsigned long long>(std::unordered_map<TString, unsigned long long*> const*& theMap) const{ theMap = &valulonglongs; }
...
template<> void BaseTreeLooper::getConsumedMap<CMSLorentzVector>(std::unordered_map<TString, CMSLorentzVector*> const*& theMap) const{ theMap = &valCMSLorentzVectors; }
...
template<> void BaseTreeLooper::getConsumedMap<std::vector<unsigned long long>>(std::unordered_map<TString, std::vector<unsigned long long>*> const*& theMap) const{ theMap = &valVulonglongs; }
...
template<> void BaseTreeLooper::getConsumedMap<std::vector<CMSLorentzVector>>(std::unordered_map<TString, std::vector<CMSLorentzVector>*> const*& theMap) const{ theMap = &valVCMSLorentzVectors; }
...
template void BaseTreeLooper::addConsumed<unsigned long long>(TString name);
...
template void BaseTreeLooper::addConsumed<CMSLorentzVector>(TString name);
...
template void BaseTreeLooper::addConsumed<std::vector<unsigned long long>>(TString name);
...
template void BaseTreeLooper::addConsumed<std::vector<CMSLorentzVector>>(TString name);

template<typename T> bool BaseTreeLooper::linkConsumed(AnalysisTree* tree){
  bool result=true;
  std::unordered_map<TString, T*>* theMap = nullptr;
  BaseTreeLooper::getConsumedMap<T>(theMap);
  if (theMap){
...
template bool BaseTreeLooper::linkConsumed<short>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<unsigned int>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<int>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<unsigned long>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<long>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<unsigned long long>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<long long>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<float>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<double>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<CMSLorentzVector>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<std::vector<short>>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<std::vector<unsigned int>>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<std::vector<int>>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<std::vector<unsigned long>>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<std::vector<long>>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<std::vector<unsigned long long>>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<std::vector<long long>>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<std::vector<float>>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<std::vector<double>>(AnalysisTree* tree);
template bool BaseTreeLooper::linkConsumed<std::vector<CMSLorentzVector>>(AnalysisTree* tree);
...
template bool BaseTreeLooper::getConsumed<unsigned long long>(TString name, unsigned long long const*& val) const;
...
template bool BaseTreeLooper::getConsumed<CMSLorentzVector>(TString name, CMSLorentzVector const*& val) const;
...
template bool BaseTreeLooper::getConsumed<std::vector<unsigned long long>>(TString name, std::vector<unsigned long long> const*& val) const;
...
template bool BaseTreeLooper::getConsumed<std::vector<CMSLorentzVector>>(TString name, std::vector<CMSLorentzVector> const*& val) const;

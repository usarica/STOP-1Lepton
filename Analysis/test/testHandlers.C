...
void testHandlers(){
  ...
  //std::string stropts = "indir=/hadoop/cms/store/group/snt/run2_data2018 outdir=./ outfile=Run2018D-PromptReco-v2_MET_480.root sample=/MET/Run2018D-PromptReco-v2/MINIAOD inputfiles=merged_ntuple_531.root year=2018 maxevents=1 ismc=false"; // Event 128659 throws an exception in TTree::GetEntry
  ...
  //vertexPUHandler.setVerbosity(TVar::DEBUG);
  ...
  //analyzer.setVerbosity(TVar::DEBUG_VERBOSE);
  ...
  //analyzer.setNSkippedSelected(128659);
